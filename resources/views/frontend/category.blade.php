                                ...
                                <ul id="sidebarNav1" class="list-unstyled dropdown-list">
                                    ...
                                    @foreach ($categories as $category)
                                        <li><a class="dropdown-item"
                                                href="{{ route('specific_category', $category->slug) }}">{{ $category->name }}<span
                                                    class="text-gray-25 font-size-12 font-weight-normal">
                                                    ({{ $category->products_count }})</span></a></li>
                                    @endforeach
                                    <!-- End Menu List -->
                                </ul>
                            </div>
                                ...
                                <div class="collapse" id="collapseColor">
                                    <div class="form-group d-flex align-items-center justify-content-between mb-2 pb-1">
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <label class="custom-control-label" for="categoryShorts">{{ $website->name }}
                                                <span class="text-gray-25 font-size-12 font-weight-normal">
                                                    ({{ $website->products_count }})</span></label>
                                        </div>
                                    </div>
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-4">
                            <div class="row">
                                ...
                                <div class="col">
                                    <h3 class="text-lh-1dot2 font-size-14 mb-0"><a
                                            href="../shop/single-product-fullwidth.html">Tablet Thin EliteBook Revolve 810
                                            G6</a></h3>
                                    <div class="text-warning text-ls-n2 font-size-16 mb-1" style="width: 80px;">
                                        <small class="fas fa-star"></small>
                                        <small class="fas fa-star"></small>
                        ...
                        <li class="mb-4">
                            <div class="row">
                                ...
                                <div class="col">
                                    <h3 class="text-lh-1dot2 font-size-14 mb-0"><a
                                            href="../shop/single-product-fullwidth.html">Notebook Purple G952VX-T7008T</a>
                                    </h3>
                                    <div class="text-warning text-ls-n2 font-size-16 mb-1" style="width: 80px;">
                                        <small class="fas fa-star"></small>
                                        <small class="fas fa-star"></small>
                        ...
                        <li class="mb-4">
                            <div class="row">
                                ...
                                <div class="col">
                                    <h3 class="text-lh-1dot2 font-size-14 mb-0"><a
                                            href="../shop/single-product-fullwidth.html">Laptop Yoga 21 80JH0035GE W8.1</a>
                                    </h3>
                                    <div class="text-warning text-ls-n2 font-size-16 mb-1" style="width: 80px;">
                                        <small class="fas fa-star"></small>
                                        <small class="fas fa-star"></small>
                                        ...
                                        <div class="product-item__body pb-xl-2">
                                            ...
                                            <div class="mb-2">
                                                <a href="../shop/single-product-fullwidth.html"
                                                    class="d-block text-center"><img class="img-fluid"
                                                        src="../../assets/img/212X200/img9.jpg" alt="Image Description"></a>
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <ul class="font-size-12 p-0 text-gray-110 mb-4">
                                                ...
                                                <li class="line-clamp-1 mb-1 list-bullet">Made of supreme quality, durable
                                                    EVA crush resistant, anti-shock material.</li>
        ...
        <div class="mb-6">
            <div class="py-2 border-top border-bottom">
                <div class="js-slick-carousel u-slick my-1" data-slides-show="5" data-slides-scroll="1"
                    ...
                    data-responsive='[{"breakpoint": 992,"settings": {"slidesToShow": 2}}, {"breakpoint": 768,"settings": {
                                "slidesToShow": 1}
                                                                                                                                                                                            }, {
                                                                                                                                                                                                "breakpoint": 554,
                                                                                                                                                                                                "settings": {
                    ...
                    @foreach ($websites as $website)
                        <div class="js-slide">
                            <a href="{{ $website->link }}" class="link-hover__brand">
                                <img class="img-fluid m-auto max-height-50"
                                    src="{{ $website->getFirstMediaUrl('logos') }}" alt="Image Description">
                            </a>
                        </div>
                    @endforeach
                </div>
                                ...
                                <ul id="sidebarNav" class="list-unstyled mb-0 sidebar-navbar">
                                    <li>
                                        <a class="dropdown-toggle dropdown-toggle-collapse dropdown-title"
                                            href="javascript:;" role="button" data-toggle="collapse" aria-expanded="false"
                                            aria-controls="sidebarNav1Collapse" data-target="#sidebarNav1Collapse">
                                            Show All Categories
                                        </a>

                ...
                <div class="bg-gray-1 flex-center-between borders-radius-9 py-1">
                    ...
                    <div class="d-flex">
                        ...
                        <select onChange="window.location.href=this.value"
                            ...
                            <option value="{{route('search_product', ['query'=>request()['query'],'sort'=>'latest'])}}">
                                Sort by
                                latest
                            </option>
                            <option
                                value="{{route('search_product', ['query'=>request()['query'],'sort'=>'low_high'])}}">
                                Sort by
                                price: low to
                                high
                            </option>
                            <option
                                value="{{route('search_product', ['query'=>request()['query'],'sort'=>'high_low'])}}">
                                Sort by
                                price: high to
                                low
                            </option>

                ...
                <div class="col-lg-7">
                    <div class="row">
                            ...
                            <ul class="list-group list-group-flush list-group-borderless mb-0 list-group-transparent">
                                @foreach($categories->take(7) as $category)
                                    <li><a class="list-group-item list-group-item-action"
                                           href="{{ route('specific_category', $category->slug) }}">{{$category->name}}</a>
                                    </li>
                                @endforeach
                            </ul>
                            <!-- End List Group -->
                        ...
                        <div class="col-12 col-md mb-4 mb-md-0">
                            ...
                            <!-- List Group -->
                            <ul class="list-group list-group-flush list-group-borderless mb-0 list-group-transparent">
                                <li><a class="list-group-item list-group-item-action" href="{{route('my-account.index')}}">My
                                        Account </a></li>
                                <li><a class="list-group-item list-group-item-action"
                                       href="{{route('wishlist.index')}}">Wish
                                        List</a></li>
                                <li><a class="list-group-item list-group-item-action"

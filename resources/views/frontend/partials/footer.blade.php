    ...
    <div class="container d-none d-lg-block mb-3">
        <div class="row">
                ...
                <div class="widget-column">
                    ...
                    <ul class="list-unstyled products-group">
                        ...
                        <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                            <div class="col-auto">
                                <a href="#" class="d-block width-75 text-center"><img class="img-fluid" src="{{ $product->getFirstMediaUrl('products') }}" alt="Image Description"></a>
                            </div>
                            <div class="col pl-4 d-flex flex-column">
                                <h5 class="product-item__title mb-0"><a href="#" class="text-blue font-weight-bold">{{ $product->title }}</a></h5>
            ...
            <div class="col-wd-3 d-none d-wd-block">
                <a href="#" class="d-block"><img class="img-fluid" src="{{asset('assets/img/330X360/img1.jpg')}}" alt="Image Description"></a>
            </div>
        </div>
    </div>
    ...
    <div class="bg-gray-14 py-2">
        <div class="container">
            <div class="flex-center-between d-block d-md-flex">
                <div class="mb-3 mb-md-0">© <a href="{{ url('/') }}" class="font-weight-bold text-gray-90">Electro</a> - All rights Reserved</div>

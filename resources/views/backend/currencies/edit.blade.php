...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">Currency Update Form</h6>
                    <form class="forms-sample" method="POST" action="{{ route('currencies.update', $currency->id) }}"
                        ...
                        <a href="{{ route('currencies.index') }}" class="btn btn-light">Cancel</a>
                    </form>
                </div>
            </div>
        </div>

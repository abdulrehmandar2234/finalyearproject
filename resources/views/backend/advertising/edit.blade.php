...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">Advertisement Update Form</h6>
                    <form class="forms-sample" method="POST" action="{{ route('advertising.update', $advertising->id) }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" name="image" class="file-upload-default" value="{{ $advertising->getFirstMediaUrl('image') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="title" autocomplete="off" placeholder="Title"
                                   name="title" value="{{$advertising->title}}">
                        </div>
                        <div class="form-group">
                            <label for="link">Product Link</label>
                            <input type="url" class="form-control" id="link" autocomplete="off"
                                   placeholder="Product link" name="link" value="{{$advertising->link}}">
                        </div>

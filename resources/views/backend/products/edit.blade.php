...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">Product Update Form</h6>
                    <form class="forms-sample" method="POST" action="{{ route('products.update', $product->id) }}"
                        ...
                        <div class="form-group">
                            ...
                            <select class="js-example-basic-single w-100" name="website_id" id="website_id">
                                @foreach($websites as $website)
                                    <option
                                        value="{{$website->id}}" {{$product->website_id == $website->id ? 'selected' : ''}}>{{$website->name}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" name="image" id="image" class="file-upload-default" value="{{$product->image}}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group date datepicker" id="datePickerExample">
                                <input type="text" name="last_updated" class="form-control" value="{{$product->last_updated}}"><span class="input-group-addon"><i data-feather="calendar"></i></span>
                            </div>
                        </div>

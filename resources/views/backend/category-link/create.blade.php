...
<div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('category-links.index') }}">Category Links</a></li>
            <li class="breadcrumb-item active" aria-current="page">Create Category Link</li>
        </ol>
    </nav>
</div>
...
<div class="row"> 
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h6 class="card-title">Category Link Form</h6>
                <form class="forms-sample" method="POST" action="{{ route('category-links.store') }}" >
                    @csrf
                    <div class="form-group">
                        <label for="category_link">Category Link</label>
                        <input type="url" class="form-control" id="category_link" autocomplete="off" placeholder="Category Link" name="category_link"> 
                    </div>
                    <div class="form-group">

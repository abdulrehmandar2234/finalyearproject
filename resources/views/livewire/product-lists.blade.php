<div>
    ...
    <div class="tab-content" id="pills-tabContent">
        ...
        <div class="tab-pane fade pt-2" id="pills-three-example1" role="tabpanel"
            ...
            <ul class="row list-unstyled products-group no-gutters">
                @forelse ($top_rated_cart as $product)
                    <li class="col-6 col-wd-3 col-md-3 product-item" wire:click="getProduct({{$product->product->id}})">
                        <div class="product-item__outer h-100">
                            <div class="product-item__inner px-xl-4 p-3">
                                <div class="product-item__body pb-xl-2" data-toggle="modal"
                                     data-target=".bd-example-modal-lg">
                                    <img src="{{$product->product->website->getFirstMediaUrl('logos','logo-resize')}}"
                                         alt="">
                ...
                @empty
                    <h4>No Product Found</h4>
                @endforelse
                @forelse ($top_rated_wishlist as $product)
                    <li class="col-6 col-wd-3 col-md-3 product-item" wire:click="getProduct({{$product->product->id}})">
                        <div class="product-item__outer h-100">
                            <div class="product-item__inner px-xl-4 p-3">
                                <div class="product-item__body pb-xl-2" data-toggle="modal"
